...
require_once dirname(__FILE__) . '/includes/Modules/fbconfig.php';
...
if(isset($accessToken)){
    ...
    // Get logout url
    $logoutURL = $fbhelper->getLogoutUrl($accessToken, $fbRedirectUrl.'logout.php');
...
if (\TVMates\Libs\Helper::isAjax()) {
    echo json_encode(['link' => $facebookLoginUrl]);
    exit;
}